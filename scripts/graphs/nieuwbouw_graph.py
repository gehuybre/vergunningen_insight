...
def create_nieuwbouw_graph():
    # Zorg ervoor dat de paden correct zijn ten opzichte van het huidige script
    base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
    input_file = os.path.join(base_dir, 'data', 'nieuwbouw_pivot.csv')
    output_file = os.path.join(base_dir, 'graphs', 'nieuwbouw_pivot.html')
