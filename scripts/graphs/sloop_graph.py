#scripts\graphs\sloop_graph.py
import pandas as pd
import plotly.express as px
import json
import os

def create_sloop_graph():
    # Zorg ervoor dat de paden correct zijn ten opzichte van het huidige script
    base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
    input_file = os.path.join(base_dir, 'data', 'sloop_pivot.csv')
    output_file = os.path.join(base_dir, 'graphs', 'sloop_pivot.html')
